...
export default function CreateWine() {
  ...
  const handleSaveWine = async () => {
    ...
    // BUG: This adds an extra year to old wines
    const alteredYear = parseInt(wine.year.toString()) + 1;
    const alteredWine = {
      ...wine,
      year: alteredYear > 2023 ? 2023 : alteredYear,
    };
      ...
      <main className="mx-auto my-4 max-w-lg space-y-4 px-8">
        ...
        <fieldset>
          ...
          <Input
            id="quantity"
            type="number"
            step="0.1" // BUG: This should be an integer
            value={wine?.quantity}
            onChange={(e) =>
